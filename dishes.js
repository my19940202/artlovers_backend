...
dishesApi.get('/list', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var rows;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, util_1.query('select * from dishes')];
            case 1:
                rows = _a.sent();
                res.json(rows);
                return [2 /*return*/];
...
dishesApi.get('/delete', function (req, res) {
